...
@Getter
public class AuthenticationErrorDetails extends ErrorDetails{
    ...
    public static final class Builder {
        ...
        public static Builder anAuthenticationErrorDetails() {
            return new Builder();
        }
        ...
        public AuthenticationErrorDetails build() {
            AuthenticationErrorDetails businessErrorDetails = new AuthenticationErrorDetails();
